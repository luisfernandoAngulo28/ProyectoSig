...
var userAgent = navigator.userAgent.toLowerCase(),
    ...
    plugins = {
      ...
      googleMapLibraries: '//maps.googleapis.com/maps/api/js?key=AIzaSyBM9WvJSlDEv4CVMuCABBosg4Z-mcOB7hM&v=3.exp&sensor=false&libraries=places',
      ...
      [].slice.call(plugins.mailForm).forEach(function (item) {
        var $currentForm = $(item),
            mailFormSettings = {
              ...
              msg: {
                'MF000': 'Su mensaje fue enviado correctamente.',
                'MF255': 'Hubo un error al enviar su mensaje, inténtelo nuevamente..'
              }
            },
    ...
    $.getScript(plugins.googleMapLibraries)
        .done(function () {
          ...
          var map = new google.maps.Map(document.getElementById('map'), {
            center: {lat: -16.5445518, lng: -68.0803528},
            zoom: 13,
            icon:image,
            styles: [{
          ...
          var beachMarker = new google.maps.Marker({
            position: {lat: -16.5445518, lng: -68.0803528},
            map: map,
            icon: image
          });
