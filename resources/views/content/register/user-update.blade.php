                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form method="POST" action="/customer-admin/model" accept-charset="UTF-8"
                                            name="edit_user" id="edit_user" role="form"
                                            ...
                                            <div class="row flex">
                                                ...
                                                <div id="field_name" class="col-sm-6 flex-item "><label for="name"
                                                        ...
                                                        class="form-control input-lg "  value="{{ $user->first_name }}" id="first_name" name="first_name"
                                                        type="text">
                                                    <div class="error">
                                                        {{ $errors->has('first_name') ? 'Debe llenar este campo' : '' }}
                                                    </div>
                                                </div>

                                                <div style="display: none" id="field_name" class="col-sm-6 flex-item ">
                                                    <label for="name" class="control-label">Nombre (*)</label><input
                                                        class="form-control input-lg " value="{{ $user->name }}" id="name" name="name"
                                                ...
                                                <div id="field_date_birth" class="col-sm-6 flex-item "><label
                                                        ...
                                                        nacimiento</label><input value="{{ $user->date_birth }}"
                                                ...
                                                <div id="field_cellphone" class="col-sm-6 flex-item "><label
                                                        ...
                                                        type="number" value="{{ $user->cellphone }}">
                                                ...
                                                <div id="field_gender" class="col-sm-6 flex-item "><label for="gender"
                                                        class="control-label">Género (*)</label><select
                                                ...
                                                <div id="field_role_user" class="col-sm-6 flex-item" style="display: none">
                                                    <label for="role_user" class="control-label">
                                                        Rango del Usuario (*) | 
                                                        <a rel="role_user" class="unselect-radio" href="#">X</a>
                                                    </label>
                                                    <div class="mt-radio-inline">
                                                        <label class="mt-checkbox">
                                                            Passenger
                                                            <input checked class="field_role_user option_3" id="role_user"
                                                                   data-checkbox="true" name="role_user[]" type="checkbox" 
                                                                   value="3">
                                                            <span></span>
                                                        </label>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 left">
                                                    <input name="action_form" type="hidden" value="edit">
                                                    <input name="model_node" type="hidden" value="user">
                                                    <input name="id" type="hidden" value="{{ $user->id }}">
                                                    <br>
                                                    <button type="submit" name="button"
                                                        class="btn btn-primary mr-1 mb-1 btn-site waves-effect waves-light">Guardar</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
