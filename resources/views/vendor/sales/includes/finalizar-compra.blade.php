    ...
    <div class="order-block">
      @if(!$auth)
        ...
        @if(config('solunes.socialite'))
          <h3>O REGÍSTRATE VÍA REDES SOCIALES</h3>
      ...
      @endif
      <form action="{{ url('process/finish-sale-t') }}" method="post">
        @if(!$auth)
          <h3>REGISTRO DE CLIENTE</h3>
        @else
          <h3>DATOS PARA SU COMPRA</h3>
          <div class="m-4">
            <small>Los datos marcados con un <span style="color:red;">(*)</span> son datos obligatorios y necesarios para poder finalizar su compra.</small>
          </div>
        @endif
        <div class="store-form">           
          <div class="row">
          ...
          <div class="payment-method">
            <div class="payment-accordion">
              <div class="panel-group" id="accordion-shipping" role="tablist" aria-multiselectable="false">
                @foreach($shipping_descriptions->whereIn('id', [6,7,8])->sortBy('id')->reverse() as $key => $shipping)
