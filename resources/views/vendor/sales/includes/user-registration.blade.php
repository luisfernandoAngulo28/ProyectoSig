@if(config('sales.delivery')&&config('sales.delivery_city'))
  ...
  <div class="col-md-12">
    ...
    <div class="checkout-form-list">
      ...
      {!! Form::select('city_id', $cities, 1, ['id'=>'city_id', 'class'=>'query_shipping']) !!}
    </div>
  </div>
...
@if(config('sales.ask_address')&&!$quotation)
  <div class="col-md-12">
    <div class="checkout-form-list">
      ...
      {!! Form::text('address', $address, ['placeholder'=>'Datos de zona, barrio, calle, número', 'required'=>true]) !!}
    </div>
  </div>
  <div class="col-md-12">
    <div class="checkout-form-list">                  
...
@endif
<div class="col-md-12 show-in-all">
    <div class="checkout-form-list hide-now">
        <label>Método de envío <span class="required">*</span></label>
        {!! Form::select('shipping_id', [], null, ['id'=>'shipping_id', 'class'=>'query_shipping_2']) !!}
    </div>
</div>
  ...
  @if(config('sales.sales_cellphone'))
    <div class="col-md-6">
      <div class="checkout-form-list">
        ...
        {!! Form::text('cellphone', NULL, ['placeholder'=>'Teléfono o celular', 'required'=>true]) !!}
      </div>
    </div>
  @endif
  ...
  @if(config('sales.sales_cellphone'))
    <div class="col-md-6">
      <div class="checkout-form-list">
        ...
        {!! Form::text('cellphone', auth()->user()->cellphone, ['placeholder'=>'Teléfono o celular', 'required'=>true]) !!}
      </div>
    </div>
  @endif
@endif
<div class="col-md-12 mb-5 main-gift d-none">
    <div class="form-check">
        <label class="form-check-label" for="check-home-delivery">Enviar como regalo</label>
        {!! Form::checkbox('gift', null, false, ['class' => 'form-check-input', 'id'=>'check-gift']) !!}
    </div>
</div>

<div class="col-md-12 gitf-class">
    <div class="checkout-form-list">
      <label>Nombre de la persona que recibe el regalo</label>                   
      {!! Form::text('gift_name', NULL) !!}
    </div>
</div>
<div class="col-md-12 gitf-class">
    <div class="checkout-form-list">
      <label>Teléfono de la persona que recibe el regalo</label>                   
      {!! Form::text('gift_cellphone', NULL) !!}
    </div>
</div>
<div class="col-md-12 gitf-class">
    <div class="checkout-form-list">
      <label>Mensaje incluido en el regalo</label>                   
      {!! Form::text('gift_message', NULL) !!}
    </div>
</div>

@if(config('sales.ask_coordinates')&&!$quotation)
  <div class="col-md-12 hide-map">
