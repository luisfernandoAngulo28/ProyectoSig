...
@if (!$pdf)
    ...
    <body
        class="m-page--fluid m-page--loading-enabled m-page--loading m-header--fixed m-header--fixed-mobile m-footer--push m-aside--offcanvas-default admin-site">
                                ...
                                <div class="m-stack m-stack--ver m-stack--general m-stack--inline">
                                    <div class="m-stack__item m-stack__item--middle m-brand__logo">
                                        <a href="{{ url('inicio') }}" class="m-brand__logo-wrapper">
                                            <img alt="" src="{{ asset('assets/img/logoadmin.png') }}"
                                    ...
                                    <div class="m-header-search__wrapper">
                                        ...
                                        <span class="m-header-search__input-wrapper">
                                            <input autocomplete="off" type="text" name="q"
                                                class="m-header-search__input" value="" placeholder="Buscar..."
                                                ...
                                                @if (auth()->user()->hasPermission('dashboard'))
                                                    <li class="m-nav__item m-topbar__notifications m-dropdown m-dropdown--large m-dropdown--arrow m-dropdown--align-center  m-dropdown--mobile-full-width"
                                                        ...
                                                        <a href="#" class="m-nav__link m-dropdown__toggle"
                                                            @if ($notifications_unread > 0) id="m_topbar_notification_icon" @endif>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                @foreach ($notifications as $notification)
                                                                                                    <div
                                                                                                        class="m-list-timeline__item @if ($notification->checked_date) m-list-timeline__item--read @endif ">
                                                                                                        <span
                                                                        ...
                                                                        <div class="m-scrollable"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="m-nav-grid__row">
                                                                                    ...
                                                                                    <a href="{{ url('admin/model-list/user') }}"
                                                                                        class="m-nav-grid__item">
                                                                                        <i
                                                                                ...
                                                                                <div class="m-nav-grid__row">
                                                                                    ...
                                                                                    <a href="{{ url('admin/model-list/contact-form') }}"
                                                                                        class="m-nav-grid__item">
                                                                                        <i
                                                ...
                                                <li class="m-nav__item m-topbar__user-profile  m-dropdown m-dropdown--medium m-dropdown--arrow  m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light"
                                                    ...
                                                    <a href="#" class="m-nav__link m-dropdown__toggle">
                                                        <span class="m-topbar__userpic">
                                                            <img src="{{ asset('assets/admin/img/no_picture.jpg') }}"
                            ...
                            <div class="m-stack__item m-stack__item--fluid m-header-menu-wrapper">
                                ...
                                <div id="m_header_menu"
                                    ...
                                    <ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
                                        @include('master::includes.menu-logged', [
                                            'items' => $menu_main->roots(),
                                        ])
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="m-stack m-stack--flex-tablet-and-mobile m-stack--ver m-stack--desktop">
                            <div class="m-stack__item m-stack__item--left m-stack__item--middle m-stack__item--last">
                                <span class="m-footer__copyright">
                                    {{ $footer_name . ' ' . date('Y') . ' | ' . $footer_rights }} |
                                    {{ trans('master::layout.developed_by') }}
                      ...
                      About
                                    ...
                                    <li class="m-nav__item">
                                        <a href="#" class="m-nav__link" data-toggle="m-tooltip"
                                            title="Ayuda: Muy Pronto" data-placement="left">
