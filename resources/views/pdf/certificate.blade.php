...
<head>
  ...
  <style>
    ...
    .middle { position: relative; max-width: 850px; margin: auto; text-align: center; background: url("{{ asset('assets/img/pdf-watermark.png') }}") center center no-repeat; background-size: 70%; }
    ...
    .middle .name-block { width: 85%; margin: auto; padding-top: 150px; color: #000; font-family: 'pantonbold_italic'; font-weight: bold; border-bottom: 3px solid #004da2; font-size: 45px; padding-bottom: 5px; }
    ...
    .bottom .logo { float: right; width: 9%; margin-right: 6%; margin-top: 30px; }
  </style>
</head>
<body>
  ...
  <div class="middle">
    ...
    <p>Ha sido partícipe del evento <strong>Seminarios 360</strong> en fecha 15 de septiembre de 2017,<br>
    llevado a cabo en el campus de la Universidad Privada Boliviana.</p>
  ...
  <div class="bottom">
    ...
    <img class="logo" src="{{ asset('assets/img/pdf-logo.png') }}" />
  </div>
</body>
</html>