    ...
    <body class="main-site ctt-menu_mobile" id="bar_mobile">
        ...
        <main class="body-bg">
            ...
            @if(Session::has('message_error'))
                <div class="container"><div id="alert" class="alert alert-danger center">{{ Session::get('message_error') }}</div></div>
            @elseif (Session::has('message_success'))
                <div class="container"><div id="alert" class="alert alert-success center">{{ Session::get('message_success') }}</div></div>
            @endif
...
<!-- <script type="text/javascript">
    ...
    s1.async=true;
    s1.src='https://embed.tawk.to/63adaf1ac2f1ac1e202abb8a/1glf780hh';
    s1.charset='UTF-8';
